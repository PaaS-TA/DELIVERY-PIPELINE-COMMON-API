...
public class PipelineServiceTest {
    ...
    public void getPipelineList_Valid_ReturnList() throws Exception{
        ...
        when(pipelineRepository.findAll(gTestPageable)).thenReturn(pipelinePage);
        when(commonService.setPageInfo(pipelinePage, PipelineList.class)).thenReturn(gTestResultPipelineList);
